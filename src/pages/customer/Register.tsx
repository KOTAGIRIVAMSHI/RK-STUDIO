...
import { UserPlus, Loader2, AlertCircle, Camera, Chrome } from 'lucide-react';
        ...
        <AnimatePage>
            ...
            <section className="relative min-h-[30vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center max-w-4xl px-4 pt-24">
                    ...
                    >
                        Join the <span className="text-studio-gold italic">Studio</span>
                    </motion.h1>
                </div>
            </section>
            ...
            <div className="py-16 bg-studio-neutral flex flex-col items-center justify-center relative overflow-hidden">
                {/* Decorative Elements */}
                <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-studio-gold/5 blur-[120px] rounded-full" />
                <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-studio-gold/5 blur-[120px] rounded-full" />
                    ...
                    <div className="text-center mb-12">
                        <Link to="/" className="inline-flex items-center gap-3 mb-8 group">
                            ...
                            <div className="text-left">
                                ...
                                <div className="text-[10px] font-sans tracking-[0.3em] uppercase opacity-40">Discovery</div>
                            </div>
                        </Link>
                        <h1 className="text-4xl font-serif font-bold text-studio-dark mb-3">Join the Studio</h1>
                        <p className="text-gray-400 font-sans text-sm">Create an account to preserve your life's best moments.</p>
                    </div>
                    ...
                    <div className="premium-card !p-12 relative overflow-hidden">
                        <form onSubmit={handleRegister} className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label className="block text-[10px] uppercase tracking-widest font-bold text-gray-400 mb-3 ml-2">Confirm</label>
                                    <input
                                        type="password"
                                        required
                                        className="input-field"
                        ...
                        <div className="relative my-10">
                            ...
                            <div className="relative flex justify-center text-xs uppercase tracking-widest font-bold text-gray-300">
                                <span className="bg-[#faf9f6] px-4">Or sign up with</span>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <span className="opacity-60 group-hover:opacity-100 font-bold tracking-[0.2em] text-[10px] uppercase">Google Account</span>
                        </button>
                    </div>

                    <p className="mt-10 text-center text-sm text-gray-400">
                        Already have an account? {' '}
                        <Link to="/login" className="text-studio-gold font-bold hover:underline transition-all">Sign in here</Link>
                    </p>
                </motion.div>
            </div>
        </AnimatePage>
